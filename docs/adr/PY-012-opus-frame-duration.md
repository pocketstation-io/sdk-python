# PY-012-opus-frame-duration — Opus Frame Duration

> **Historical record.** This Relay codec note does not define the current
> SDK. See [Python SDK design](../PYTHON_SDK_DESIGN.md).
